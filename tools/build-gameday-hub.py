...
def termine(liste, aktuelles):
    ...
    Die Einzelticket-Preisbox stand hier bis 27.08.2026 zusätzlich neben der
    Dauerkarte -- raus, seit der Kaufbereich mit den echten Einzelticketpreisen
    weiter oben auf dem Hub sitzt (kauf_bereich()); zwei Preislisten für
    dasselbe Ticket auf einer Seite wären nur Redundanz gewesen (Marko,
    27.08.2026).
...
<link rel="stylesheet" href="/css/site.css?v=1789832992" />
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {{
    ...
    document.addEventListener('keydown', function (e) {{
      ...
      document.getElementById('overview-member-modal-backdrop').classList.remove('open');
    }});
  }});
</script>
